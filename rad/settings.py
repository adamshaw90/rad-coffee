...
SECRET_KEY = 'django-insecure-%tv#2xaycd1pa85fd#exrrcs(cs*zrew505xgtcm2off*-!b95'
...
# Send emails to the console temporarily
...
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')  # Heroku's storage location
